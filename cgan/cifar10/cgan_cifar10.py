...
from keras.layers import BatchNormalization, Activation, Embedding, ZeroPadding2D, MaxPooling2D, Conv2DTranspose
...
class CGAN():
    ...
    def single_sample_images(self, epoch):
        ...
        axs.axis('off')
        fig.savefig("Keras-GAN/cgan/cifar10/single_cifar10_images/%d.png" % epoch)
        plt.close()
    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("Keras-GAN/cgan/cifar10/cifar10_images/%d.png" % epoch)
        plt.close()
